...
<p className="text-xl text-cyan-300 font-semibold">
  {getExperienceYears()} лет успешного преподавания — помогаю людям уверенно говорить по-английски
    ...
    <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">Первый урок-знакомство — бесплатно!</p>
    <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">Определим ваш уровень, обсудим цели и составим план.</p>
